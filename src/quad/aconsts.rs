...
impl Quad {
    ...
    /// The radix or base of the internal representation of `Quad`. This is the
    /// same as the representation in the underlying f64.
    ...
    /// The full circle constant ($\tau$), or $2\pi$. The value of this constant
    /// is 6.2831853071795864769252867665590057683943387987502116419498892.
